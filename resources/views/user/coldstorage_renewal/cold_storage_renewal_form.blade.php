                                         ...
                                         <a href="{{url('/')}}/PMC_Cold_Storage/meat_file/property_tax_doc/{{ $data->property_tax_doc }}" target="_blank">
                                                    <div class="form-group">
                                                        ...
                                                        <?php }
                                                                    ...
                                                                    ?>
                                                                    <a href="{{url('/')}}/PMC_Cold_Storage/meat_file/property_tax_doc/{{ $data->property_tax_doc }}" target="_blank" download>
                                                                        <p class="mt-3 mb-0" id="image_div">
                                                                        <button type="button"class="btn btn-info">
                                                                            Download File
                                                                        </button>
                                       ...
                                       <a href="{{url('/')}}/PMC_Cold_Storage/meat_file/paid_water_doc/{{ $data->paid_water_doc }}" target="_blank">
                                                    <div class="form-group">
                                                        ...
                                                        <?php }
                                                                    ...
                                                                    ?>
                                                                    <a href="{{url('/')}}/PMC_Cold_Storage/meat_file/paid_water_doc/{{ $data->paid_water_doc }}" target="_blank" download>
                                                                        <p class="mt-3 mb-0" id="image_div">
                                                                        <button type="button"class="btn btn-info">
                                                                            Download File
                                                                        </button>
                                          ...
                                          <a href="{{url('/')}}/PMC_Cold_Storage/meat_file/treatment_authorized_doc/{{ $data->treatment_authorized_doc }}" target="_blank">
                                                    <div class="form-group">
                                                        ...
                                                        <?php }
                                                                    ...
                                                                    ?>
                                                                    <a href="{{url('/')}}/PMC_Cold_Storage/meat_file/treatment_authorized_doc/{{ $data->treatment_authorized_doc }} " target="_blank" download>
                                                                        <p class="mt-3 mb-0" id="image_div">
                                                                        <button type="button"class="btn btn-info">
                                                                            Download File
                                                                        </button>
                                       ...
                                       <a href="{{url('/')}}/PMC_Cold_Storage/meat_file/fitness_certificate_doc/{{ $data->fitness_certificate_doc }}" target="_blank">
                                                    <div class="form-group">
                                                        ...
                                                        <?php }
                                                                    ...
                                                                    ?>
                                                                    <a href="{{url('/')}}/PMC_Cold_Storage/meat_file/fitness_certificate_doc/{{ $data->fitness_certificate_doc }} " target="_blank" download>
                                                                        <p class="mt-3 mb-0" id="image_div">
                                                                        <button type="button"class="btn btn-info">
                                                                            Download File
                                                                        </button>
