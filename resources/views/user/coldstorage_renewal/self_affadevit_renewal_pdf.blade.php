...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8">
    <title> PMC Cold Storage Self Affidavit Renewal Application</title>
                ...
                <div class="page-header" style="border: 1px solid #000000;">
                    <div class="row">
                        ...
                        <div class="col-sm-10 col-xs-12 d-flex flex-column align-items-center align-items-sm-start">
                            <div class="title">
                                <h4>Cold Storage Self Affidavit Renewal License</h4>
                            </div>
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                                    <!--<li class="breadcrumb-item"><a href="javascript:;">Documentation</a></li>-->
                                    <li class="breadcrumb-item active" aria-current="page">Cold Storage Self Affidavit Renewal License</li>
                                </ol>
                            </nav>
                        </div>
                                   ...
                                   <p class="mb-0">
                                       I <span></span> <strong>
                                        <?php
                                         ...
                                         {{ $applicant_title_id }} {{ $meat_registration_pdf->applicant_fname }} {{ $meat_registration_pdf->applicant_mname }} {{ $meat_registration_pdf->applicant_lname }}</strong> will stay <strong> {{ $meat_registration_pdf->house_number }} ,{{ $meat_registration_pdf->house_name }}, {{ $meat_registration_pdf->street_1 }} ,{{ $meat_registration_pdf->area_1 }} ,{{ $meat_registration_pdf->dist_name }} </strong>  that all information furnished above all documents submitted by me is true & valid the best of my knowledge and belief. Also I further state that provisions of following laws and instructions given by Corporation is binding on me.</p>
