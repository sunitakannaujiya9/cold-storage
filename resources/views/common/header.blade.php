        ...
        <aside id="leftsidebar" class="sidebar" >
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <!--    </ul>-->
                    <!--</li>-->
                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Cold Storage List</span></a>
                        <ul class="ml-menu">
                            <li><a href="{{ url('/cold_storage_list', 0 ) }}">Pending Cold Storage List</a></li>
                            <li><a href="{{ url('/cold_storage_list', 1 ) }}">Approved Cold Storage List</a></li>
                            <li><a href="{{ url('/cold_storage_list', 2 ) }}">Rejected Cold Storage List</a></li>
                        </ul>
                    </li>

                     <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Cold Storage Renewal List</span></a>
                        <ul class="ml-menu">
                            <li><a href="{{ url('/cold_storage_renewal_list', 0 ) }}">Pending Cold Storage Renewal List</a></li>
                            <li><a href="{{ url('/cold_storage_renewal_list', 1 ) }}">Approved Cold Storage Renewal List</a></li>
                            <li><a href="{{ url('/cold_storage_renewal_list', 2 ) }}">Rejected Cold Storage Renewal List</a></li>
                        </ul>
                    </li>

                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Report</span></a>
                        <ul class="ml-menu">
                            <li><a href="{{ url('/all_register_coldstorage', )}}">Cold Storage Application Report</a></li>
                            <li><a href="{{ url('/all_coldstorage_renewal_report', ) }}">Cold Storage Application Renewal Report</a></li>
                          
                        </ul>
                    </li>

                    @elseif(Auth::user()->user_type == 3)
                    <li class="active open"><a href="{{ url('/hod/dashboard') }}"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>

                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Cold Storage List</span></a>
                        <ul class="ml-menu">
                            <li><a href="{{ url('/cold_storage_lists', 0 ) }}">Pending Cold Storage List</a></li>
                            <li><a href="{{ url('/cold_storage_lists', 1 ) }}">Approved Cold Storage List</a></li>
                            <li><a href="{{ url('/cold_storage_lists', 2 ) }}">Rejected Cold Storage List</a></li>
                        </ul>
                    </li>

                  

                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Final Approve List </span></a>
                        <ul class="ml-menu">
                            <li><a href="{{ url('/admin_approve_list', 0 ) }}">Final HOD Pending List </a></li>
                            <li><a href="{{ url('/admin_approve_list', 1 ) }}">Final HOD Approved List</a></li>
                            <li><a href="{{ url('/admin_approve_list', 2 ) }}">Final HOD Rejected List</a></li>
                        </ul>
                    </li>
                    ...
                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Cold Storage Renewal List </span></a>
                        <ul class="ml-menu">
                            <li><a href="{{ url('/hod_cold_storage_renewal_list', 0) }}">Pending</a></li>
                            <li><a href="{{ url('/hod_cold_storage_renewal_list', 1) }}">Approved</a></li>
                            <li><a href="{{ url('/hod_cold_storage_renewal_list', 2) }}">Rejected</a></li>
                        </ul>
                    </li>

                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Final Approve Renewal List </span></a>
                        <ul class="ml-menu">
                            <li><a href="{{ url('/admin_approve_list_renewal', 0 ) }}">Final HOD Pending Renewal List </a></li>
                            <li><a href="{{ url('/admin_approve_list_renewal', 1 ) }}">Final HOD Approved Renewal List</a></li>
                            <li><a href="{{ url('/admin_approve_list_renewal', 2 ) }}">Final HOD Rejected Renewal List</a></li>
                        </ul>
                    </li>

                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Admin Rejected List </span></a>
                        <ul class="ml-menu">
                            <li><a href="{{ url('/admin_rejected_list', 2 ) }}">Admin Rejected List </a></li>
                            <li><a href="{{ url('/admin_rejected_list_renewal', 2 ) }}">Admin Rejected RenewalList </a></li>
                        </ul>
                    </li>

                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-receipt"></i><span>Report</span></a>
                        <ul class="ml-menu">
                            <li><a href="{{ url('/hod_cold_Report_List', )}}">Cold Storage Application Report</a></li>
                            <li><a href="{{ url('/hod_cold_renewal_Report', )}}">Cold Storage Application Renewal Report</a></li>
