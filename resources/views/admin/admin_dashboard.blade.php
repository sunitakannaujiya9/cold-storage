@include('common.header')
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                ...
                <!--                </ul>-->
                <!--                <div class="img">-->
                <!--                    <img src="{{ url('/') }}/assets/images/lg/avatar1.jpg" class="rounded-circle" alt="profile-image">-->
                <!--                </div>-->
                <!--                <div class="user">-->
                ...
                <!--                        <li class="left">-->
                <!--                            <img src="{{ url('/') }}/assets/images/xs/avatar3.jpg" class="rounded-circle" alt="">-->
                ...
                <!--                        </li>-->
                <!--                        <li class="left">-->
                <!--                            <img src="{{ url('/') }}/assets/images/xs/avatar2.jpg" class="rounded-circle" alt="">-->
                <!--                            <ul class="list-unstyled chat_info">-->
                ...
                <!--                        </li>-->
                <!--                        <li class="left">-->
                <!--                            <img src="{{ url('/') }}/assets/images/xs/avatar5.jpg" class="rounded-circle" alt="">-->
                <!--                            <ul class="list-unstyled chat_info">-->
