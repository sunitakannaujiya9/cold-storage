            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Meat</li>
                    </ul>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="body">
                            <form method="post" action="{{ url('/meat_type_master') }}" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="pd-20 card-box mb-30">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <input type="text" name="meat_name" id="meat_name" class="form-control @error('meat_name') is-invalid @enderror" value="{{ old('meat_name') }}" placeholder="Enter Meat Name.">
                                            @error('meat_name')
