        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="body">
                            <form method="post" action="{{ route('department_master.update', $data->id) }}" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="pd-20 card-box mb-30">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <select class="form-control show-tick @error('ward_id') is-invalid @enderror" data-live-search="true" name="ward_id" id="ward_id" style="width: 100%; height: 38px;">
                                                ...
                                                @foreach ($ward_mst as $key => $value)
                                                    <option value="{{ $key }}" {{ $data->ward_id == "$key" ? 'selected' : '' }}>{{ $value }}</option>
                                                @endforeach
                                            </select>
                                            @error('ward_id')
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <input type="text" name="dept_name" id="dept_name" class="form-control @error('dept_name') is-invalid @enderror" value="{{ $data->dept_name }}" placeholder="Enter Department Name.">
                                            @error('dept_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
