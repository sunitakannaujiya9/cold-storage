            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <!--</div>-->
                        <div class="body p-3">
                            <form method="post" action="{{ url('/search_all_coldstorage_list') }}" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <tbody>
                                        ...
                                        @if(!empty($meat_search_registration_list))
                                            ...
                                            ?>
                                                    ...
                                                    <!--<td>-->
                                                    <!--    <a href="{{ url('/all_register_pet/view', $value->cold_storage_aplication_no ) }}"  class="btn btn-primary waves-effect m-r-20">-->
                                                    <!--        View-->
                                                    <!--    </a>-->
                                                    <!--</td>-->
                                                </tr>
