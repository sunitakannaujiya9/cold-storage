        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="body">
                            <form method="post" action="{{ url('/district_master') }}" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="pd-20 card-box mb-30">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <input type="text" name="dist_name" id="dist_name" class="form-control @error('dist_name') is-invalid @enderror" value="{{ old('dist_name') }}" placeholder="Enter District Name.">
                                            @error('dist_name')
