                                 ...
                                 <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 col-md-4 p-2">
                                        ...
                                        <?php if($meat_registration_view->status == 0){ ?>
                                            <div class="form-group row mt-4">
                                                <label class="col-md-3"></label>
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/cold_storage_list/0') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>&nbsp;&nbsp;
                                        ...
                                        <?php } elseif($meat_registration_view->status == 1){ ?>
                                            <div class="form-group row mt-4">
                                                <label class="col-md-3"></label>
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('/cold_storage_list/1') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>&nbsp;&nbsp;
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#rejectModal">Reject</button>
                                                </div>
                                            </div>
                                        <?php } elseif($meat_registration_view->status == 2){ ?>
                                            <div class="form-group row mt-4">
                                                <label class="col-md-3"></label>
                                                <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                                                    <a href="{{ url('cold_storage_list/2') }}"><button type="button"  class="btn btn-danger">Cancel</button></a>
                                                </div>
                                            </div>
                                        <?php }?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                <form method="POST" action="{{ url('approve_cold_registration', $meat_registration_view->id ) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row mt-4">
                        <label class="col-md-3"></label>
                        <div class="col-md-9" style="display: flex; justify-content: flex-end;">
                            <a href='{{ url("/cold_storage_view/{$meat_registration_view->id}/{$meat_registration_view->status}") }}' class="btn btn-danger btn-lg">Cancel</a>&nbsp;&nbsp;
...
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                <form method="POST" action="{{ url('reject_cold_registration', $meat_registration_view->id ) }}" enctype="multipart/form-data">
                    @csrf
