        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    @if ($status == 0)
                        <h2>Pending Cold Storage Application</h2>
                    @elseif ($status == 1)
                        <h2>Approve Cold Storage Application</h2>
                    @elseif ($status == 2)
                        <h2>Reject Cold Storage Application</h2>
                    @endif
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            @if ($status == 0)
                                Pending Cold Storage Application
                            @elseif ($status == 1)
                                Approve Cold Storage Application
                            @elseif ($status == 2)
                                Reject Cold Storage Application
                            @endif
                        </li>
                    </ul>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                @if ($status == 0)
                                    <strong style="text-transform: capitalize;">Pending Cold Storage Application</strong>
                                @elseif ($status == 1)
                                    <strong style="text-transform: capitalize;">Approve Cold Storage Application</strong>
                                @elseif ($status == 2)
                                    <strong style="text-transform: capitalize;">Reject Cold Storage Application</strong>
                                @endif
                                    ...
                                    <tbody>
                                        @foreach ($meat_registration_list as $key => $value)
                                            <tr>
                								...
                								@endif
            									<td>
                                                    <a href='{{ url("/final_approve_view/{$value->id}/{$value->final_approve}") }}' class="btn btn-info btn-sm text-light">
                                                 ...
                                                 <td>
                                                    ...
                                                    <a href='{{ url("/generate_english_cold_registration_pdf/{$value->id}/{$value->final_approve}") }}'
                                                        class="btn btn-danger waves-effect waves-float btn-sm waves-green">
                                                        <i class="zmdi zmdi-file"></i> English
                                                    </a>
                                                    &nbsp;&nbsp;
                                                    <a href='{{ url("/generate_marathi_cold_registration_pdf/{$value->id}/{$value->final_approve}") }}'
                                                        class="btn btn-danger waves-effect waves-float btn-sm waves-green">
