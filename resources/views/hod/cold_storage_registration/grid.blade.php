                                    ...
                                    <tbody>
                                        @foreach ($meat_registration_list as $key => $value)
                                            <tr>
                								...
                								@endif 
            									<td>
                                                    <a href='{{ url("/cold_storage_views/{$value->id}/{$value->hod_status}") }}' class="btn btn-info btn-sm text-light">
                                                 ...
                                                 <!-- <td> -->
                                                    ...
                                                    <!-- <a href='{{ url("/generate_english_coldstorage_registration_pdf/{$value->id}/{$value->status}") }}'
                                                        class="btn btn-danger waves-effect waves-float btn-sm waves-green">
                                                        <i class="zmdi zmdi-file"></i> English
                                                    </a>
                                                    &nbsp;&nbsp;
                                                    <a href='{{ url("/generate_marathi_coldstorage_registration_pdf/{$value->id}/{$value->status}") }}'
                                                        class="btn btn-danger waves-effect waves-float btn-sm waves-green">
