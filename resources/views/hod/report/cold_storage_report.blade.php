...
<?php
        // $password = 123456789; // password is form field $hashed = Hash::make($password);
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <!--</div>-->
                        <div class="body p-3">
                            <form method="post" action="{{ url('/search_cold_Report_List') }}" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <strong style="text-transform: capitalize;"> Cold Storage Application List</strong>
                            </h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable ">
                                    <thead>
                                        <tr>
                                            <th>Sr. No.</th>
                                            <th>Cold Storage Application no.</th>
                                    ...
                                    <tbody>
                                        ...
                                        @if(!empty($meat_search_registration_list))
                                            ...
                                            ?>
                                                    ...
                                                    <td>
                                                       <a href="{{ url('/hod_cold_Report_view', $value->id ) }}"  class="btn btn-primary waves-effect m-r-20">
                                                           View
                                                       </a>
                                                    </td>
                                                </tr>
                                        ...
                                        @else
                                            ...
                                            ?>
                                                    ...
                                                    <?php ?>
                                                    <td style="display:none">{{ $value->inserted_dt }}</td>
